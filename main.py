...
def front_dev():
    ...
    try:
        ...
        studyprograms = json.dumps(get_studyprograms().get_data(), sort_keys=True)
        moduleid_studyprogramids = json.dumps(get_modules_studyprograms().get_data(), sort_keys=True)
